window.onload = () => {
    navigator.geolocation.getCurrentPosition((position) => {
        ...
        entity.setAttribute('gps-entity-place', `latitude: ${latitude - 0.0000065}; longitude: ${longitude};`);
        ...
        text.setAttribute('gps-entity-place', `latitude: ${latitude - 0.0000065}; longitude: ${longitude};`);
